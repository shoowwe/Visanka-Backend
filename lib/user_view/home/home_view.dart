...
import 'package:ott_platform_app/user_view/home/tv_show_details_view.dart';
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              SizedBox(width: 20,),
                              Expanded(child: Text('Play', style: TextStyle(color: TColor.primary2, fontSize: 30),)),
                             // Text('subscribe', style: TextStyle(color: TColor.bgText, fontSize: 13),),
                              TextButton(onPressed: () {
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => const CheckoutOnePage()));
